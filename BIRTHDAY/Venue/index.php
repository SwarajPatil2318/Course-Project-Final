    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        <a href="/" class="d-flex align-items-center mb-2 mb-lg-0 text-dark text-decoration-none">
          <img src="./photos/logo.png" class="bi me-2" width="40" height="40" role="img" aria-label="Bootstrap">
            <use xlink:href="#bootstrap"></use>
    </img>
        </a>

        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          <li><a href="/Home page/Home.html" class="nav-link px-2 link-secondary">Home</a></li>
          <li><a href="/Home page/Home.html" class="nav-link px-2 link-dark">Services</a></li>
...
<body>
    <div class="main-container container px-4 py-5" id="custom-cards">
        <h2 class="pb-2 border-bottom">Venue</h2>
        ...
        <div class="container py-4">
            <form method="GET" action="" class="row g-3 mb-4">
                ...
                <div class="col-md-2">
                    <input type="number" name="min_price" class="form-control" placeholder="Min Capacity" min="0" value="<?php echo htmlspecialchars($_GET['min_price'] ?? '', ENT_QUOTES); ?>">
                </div>
                <div class="col-md-2">
                    <input type="number" name="max_price" class="form-control" placeholder="Max Capacity" min="0" value="<?php echo htmlspecialchars($_GET['max_price'] ?? '', ENT_QUOTES); ?>">
                </div>
                <div class="col-md-2">
                    ...
                    <div class="col">
                      <div class="card card-cover h-100 overflow-hidden text-white bg-dark rounded-5 shadow-lg" 
                        ...
                        <div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
                          ...
                          <?php endif; ?>
                          <p class="mb-3"><strong>Capcity:</strong> <?php echo number_format($catering['price'], 2); ?></p>
